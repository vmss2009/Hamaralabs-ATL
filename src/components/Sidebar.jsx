        ...
        <div>
            ...
            <div className="sidebar closed">
                ...
                <ul className="navItemsContainer">
                    ...
                    <div className="subContent">
                        <Link to="/ta-gen"><li className="nav-item">Tinkering Activity Generation</li></Link>
                        <Link to="/ta-gen-report"><li className="nav-item last-li">AI TA Report</li></Link>
                    </div>
                    ...
                    {role === "admin" || role === "mentor" || role === "student" ? <> <div className="subTitle"><li className="nav-item">Apartment Complex</li></div>
                        <div className="subContent">
                            {role === "admin" || role === "mentor" ? <Link to="/apartment-data/add"><li className="nav-item">Apartment form</li></Link> : ""}
                            {role === "admin" || role === "mentor" || role === "student" ? <Link to="/apartment-data/view"><li className="nav-item last-li">Apartment report</li></Link> : ""}
                        </div> </>: ""}
