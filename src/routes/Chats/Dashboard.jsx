...
function Dashboard() {
    ...
    return (
        <div className="container">
            ...
            <button className="submitbutton createButton" title="Create new Group" onClick={createNewGroup}
                    style={{float: "right"}}><i className="fa-solid fa-plus"></i></button>
            <hr/>
            <div className="subContainer">
                {userData.chats === undefined || userData.chats.length === 0 ?
                    <button className="submitbutton" onClick={createNewGroup}><i
                        className="fa-solid fa-plus"></i> Create new Group</button>
                    : (
