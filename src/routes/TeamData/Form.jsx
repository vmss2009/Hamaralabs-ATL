...
import {addTeam, getSchools, db} from "../../firebase/firestore";
import NonTeamLeadersSelect from "./NonTeamMembersSelect";
...
function TeamForm() {
    ...
    async function handleSubmit(event) {
        ...
        if(hasDuplicates(teamMems)) {
            ...
            if(teamName ===  ""){
                ...
                await addTeam(teamName, teamLeader, teamMems, schoolVal)
                    .then(() => {
    ...
    // Assuming filteredStudents is declared like this in TeamForm component
const filteredStudents = React.useMemo(() => {
    ...
    document.title = "Team Data Form | Digital ATL";
    ...
    return (
        <div className="container" id="mobilescreen">
            ...
            <form>
                <div className="school-title">Team data form</div>
                <hr />
            ...
            <div className="column">
                ...
                <select name="schoolName" id="schoolName" value={schoolVal} placeholder="Enter your School" className="form-inp" onChange={handleChange}>
                ...
                <div className="column">
                    ...
                    <input type="text" name="teamName" id="teamName" placeholder="Enter the Team Name" className="form-inp" value={teamName} onChange={handleChange}/>
                </div>
                </div>
                </div>
            <div className="formContainer">
            ...
            <div className="column">
                ...
                <select name="teamLeader" id="teamLeader" className="form-inp" placeholder="Enter the Team Leader" onChange={handleChange}>
                    <option value="">--- Select ---</option>
                    {filteredStudents
                    .filter((student) => student.isTeamLeader)
                    .sort((a, b) => {
                        // Sort by the concatenation of first name and last name
        ...
        <div className="multiForm">
            ...
            {createArray(count).map((_, index) => (
                <NonTeamLeadersSelect key={index} index={index} teamMems={teamMems} setTeamMems={setTeamMems} students={filteredStudents}/> // Use filteredStudents here
            ))}
             {/*Nageswar*/}
        </div>
