...
import { db, updateSession, getSubjects, getTopics, getSubtopics } from "../../firebase/firestore";
...
function Form() {
    ...
    async function handleSubmit(event) {
        ...
        await updateSession(subject, topic, subTopic, dateTime, duration, prerequisites, sessionType, details, sessionId)
            .then(() => {
    ...
    React.useEffect(() => {
        const q = query(doc(db, "sessionData", sessionId));
        getSubjects()
          .then((docSnaps) => {
            const dataArray = [];
