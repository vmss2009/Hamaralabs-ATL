                    ...
                    <div className="container" style={{ fontSize: "1.2rem" }}>
                        ...
                        {checkBox !== null && role === "admin" ? (
                            <>
                                ...
                                <label>
                                    Payment required? &nbsp;
                                    <input type="checkbox" defaultChecked={checkBox} onChange={(e) => {setCheckBox(e.target.checked)}}/>
                                </label>
                            </>
                        ) : ""}
                        <br/>
                ...
                : ""}
                {
                    role === "admin" ?
                        <>
                            ...
                            <button className="submitbutton deleteBtn" onClick={async () => await cloneTA()}>Clone
                            </button>
