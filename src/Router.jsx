...
const ApartmentFrom = React.lazy(() => import("./routes/ApartmentData/Form"));
const ApartmentReport = React.lazy(() => import("./routes/ApartmentData/Report"));
const ApartmentEditForm = React.lazy(() => import("./routes/ApartmentData/EditForm"));
...
const tinkeringActivityGeneration = React.lazy(() => import("./routes/TinkeirngActivityGeneration/TinkeringActivity"));
const TinkeringActivityGenerationReport = React.lazy(() => import("./routes/TinkeirngActivityGeneration/TinkeringActivityGenerationReport"));
...
const Router = createBrowserRouter([
    ...
    },
    {
        ...
        children: [
            {
                path: "add",
                element: <AccessDeterminer accessForName="apartmentForm" accessForComponent={ApartmentFrom} />
            },
            {
                path: "view",
                element: <AccessDeterminer accessForName="apartmentReport" accessForComponent={ApartmentReport} />
            },
            {
                path: "edit/:apartmentId",
                element: <AccessDeterminer accessForName="apartmentForm" accessForComponent={ApartmentEditForm} />
            }
        ]
    },
    {
        path: "/ta-gen",
        element: <AccessDeterminer accessForName="tinkeringActivityGeneration" accessForComponent={tinkeringActivityGeneration} />
    },
    {
        path: "/ta-gen-report",
        element: <AccessDeterminer accessForName="tinkeringActivityGenerationReport" accessForComponent={TinkeringActivityGenerationReport}></AccessDeterminer>
    },
    {
        path: "/fallback",
        element: <FallBack />
