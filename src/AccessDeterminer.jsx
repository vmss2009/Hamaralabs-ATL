...
function AccessDeterminer(props) {
    ...
    if (encodedAuth !== null) {
        ...
        } else if (props.accessForName === "apartmentForm") {
            temp = "Apartment Form";
        } else if (props.accessForName === "apartmentReport") {
            temp = "Apartment Report";
        ...
        } else if (props.accessForName === "tinkeringActivityGeneration") {
            temp = "Tinkering Activity Generation";
        } else if (props.accessForName === "tinkeringActivityGenerationReport") {
            temp = "Tinkering Activity Generation Report";
        }
